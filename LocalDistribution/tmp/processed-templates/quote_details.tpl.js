define('quote_details.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "										<p>"
    + container.escapeExpression((compilerNameLookup(helpers,"translate") || (depth0 && compilerNameLookup(depth0,"translate")) || helpers.helperMissing).call(alias1,"To complete this quote, the following information is needed:",{"name":"translate","hash":{},"data":data}))
    + "</p>\n										<ul>\n"
  ...
  return "<a href=\"/quotes\" class=\"quote-details-header-back-btn\">"
    ...
    + alias3(((helper = (helper = compilerNameLookup(helpers,"quoteTotalFormatted") || (depth0 != null ? compilerNameLookup(depth0,"quoteTotalFormatted") : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"quoteTotalFormatted","hash":{},"data":data}) : helper)))
    ...
    + ((stack1 = compilerNameLookup(helpers,"if").call(alias1,(depth0 != null ? compilerNameLookup(depth0,"disableDownloadAsPDF") : depth0),{"name":"if","hash":{},"fn":container.program(44, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + ">"
